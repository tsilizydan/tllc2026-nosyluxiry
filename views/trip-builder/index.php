    ...
    <div class="container container-narrow" style="max-width:800px;">
        ...
        <div class="booking-steps" style="margin-bottom:var(--space-10);">
            ...
            <div class="booking-step" :class="{ 'active': step === 3, 'completed': step > 3 }">
                <span class="step-number">3</span><span>Details</span>
            </div>
        ...
        <form action="<?= url('/trip-builder') ?>" method="POST">
            ...
            <!-- Step 1: Destinations -->
            <div x-show="step === 1" style="background:var(--color-dark-card);border:1px solid var(--color-dark-border);border-radius:var(--radius-lg);padding:var(--space-10);">
                ...
                <div class="grid grid-3" style="gap:var(--space-4);">
                    ...
                    foreach ($dests as $d): ?>
                    <label @click="toggleDestination('<?= $d ?>')" :class="{ 'active': formData.destinations.includes('<?= $d ?>') }" class="filter-btn" style="cursor:pointer;text-align:center;">
                        <input type="checkbox" name="destinations[]" value="<?= $d ?>" style="display:none;" :checked="formData.destinations.includes('<?= $d ?>')">
                        <span><?= $d ?></span>
                    </label>
                    <?php endforeach; ?>
                </div>
            ...
            <!-- Step 2: Preferences -->
            <div x-show="step === 2" style="background:var(--color-dark-card);border:1px solid var(--color-dark-border);border-radius:var(--radius-lg);padding:var(--space-10);">
            ...
            <!-- Step 3: Interests -->
            <div x-show="step === 3" style="background:var(--color-dark-card);border:1px solid var(--color-dark-border);border-radius:var(--radius-lg);padding:var(--space-10);">
                ...
                <div class="grid grid-3" style="gap:var(--space-3);">
                    ...
                    <label @click="toggleInterest('<?= $interest ?>')" :class="{ 'active': formData.interests.includes('<?= $interest ?>') }" class="filter-btn" style="cursor:pointer;text-align:center;">
            ...
            <div x-show="step === 4" style="background:var(--color-dark-card);border:1px solid var(--color-dark-border);border-radius:var(--radius-lg);padding:var(--space-10);">
            ...
            <div style="display:flex;justify-content:space-between;margin-top:var(--space-6);">
                ...
                <div></div>
                <button type="button" @click="nextStep()" x-show="step < 4" class="btn btn-primary">
